...
public class BoardUploadFileUtil {
	// 파일이 첨부될 경로
	// final : 변수앞에 넣으면 상수값처럼 고정이되어 값 변경이 되지 않는다! -> 실수 방지 
	// 단, 상수명은 보통 모두 대문자와 _ 언더바를 사용하여 명명해준다.
	// static > images 폴더에 이미지첨부파일 자동 저장시키기
	// 경로설정
	// 학원컴퓨터버전 경로
	// private static final String UPLOAD_PATH = "D:\\worksapceSTS\\Shop\\src\\main\\resources\\static\\images\\"; 
	// 내컴퓨터 버전 경로
	private static final String UPLOAD_PATH = "C:\\workSpaceSTS\\Shop\\src\\main\\resources\\static\\images\\";
